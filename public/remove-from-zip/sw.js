...
const PRECACHE_URLS = [
  '/remove-from-zip/',
  '/remove-from-zip/manifest.json',
  '/remove-from-zip/icon-192.png',
  '/remove-from-zip/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/remove-from-zip/manifest.json';
}
